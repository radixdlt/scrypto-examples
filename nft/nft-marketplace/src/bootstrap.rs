...
mod bootstrap {
    ...
    impl Bootstrap {
        ...
        pub fn bootstrap() -> Vec<Bucket> {
            ...
            let cars: Bucket = ResourceBuilder::new_ruid_non_fungible()
            ...
            let phones: Bucket = ResourceBuilder::new_ruid_non_fungible()
            ...
            let laptops: Bucket = ResourceBuilder::new_ruid_non_fungible()
