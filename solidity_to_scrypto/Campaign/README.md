...
1. Create a badge to represent the deployed package owner: `resim new-simple-badge` -> Remember the NFAddress for the next step.
1. Build and deploy the blueprint: `resim publish . --owner-badge [owner_badge_NFAddress]`
...
1. Contribute 11 XRD to become a member: `resim call-method [component_address] contribute 11,resource_sim1qzkcyv5dwq3r6kawy6pxpvcythx8rh8ntum6ws62p95sqjjpwr`
